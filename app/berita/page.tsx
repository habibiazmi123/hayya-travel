...
export const metadata: Metadata = { title: "Seputar Umroh & Haji | Hayya Tour & Travel", description: "Artikel dan berita seputar umroh dan haji dari Hayya Tour & Travel." };
