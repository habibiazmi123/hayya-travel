...
export const metadata: Metadata = { title: "Tanya Jawab Umroh | Hayya Tour & Travel", description: "Jawaban atas pertanyaan umum seputar paket, pendaftaran, durasi, dan Muthawif Hayya.", alternates: { canonical: "/faq" } };
