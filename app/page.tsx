...
export default function Home() {
  return (
    <>
      <section className="overflow-hidden bg-pine text-white">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 md:grid-cols-[1.05fr_0.95fr] md:py-24">
          <div>
          ...
          <div className="relative h-80 overflow-hidden rounded-t-[110px] rounded-b-3xl border-4 border-gold/60 md:h-[480px]">
            ...
            <div className="absolute bottom-5 left-5 rounded-2xl border border-white/20 bg-pine/85 px-4 py-3 backdrop-blur-sm"><p className="text-xs text-gold-soft">Hayya Tour &amp; Travel</p><p className="mt-1 text-sm font-bold">Teman perjalanan ibadah Anda</p></div>
          </div>
        </div>
      </section>
