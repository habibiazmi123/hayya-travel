...
export function PackageCard({ packageInfo }: { packageInfo: PackageInfo }) {
  ...
  return (
    <article className="flex flex-col overflow-hidden rounded-2xl border border-[#eee8dc] bg-white shadow-[0_8px_24px_rgba(20,45,36,0.06)] transition-transform hover:-translate-y-1">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <p className="mt-4 text-sm font-extrabold text-[#A67C2E]">Mulai {formatIDR(packageInfo.priceFrom)}</p>
